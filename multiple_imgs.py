...
for file in glob.glob(path):
    ...
    img = rgb2gray(img1)
    img = util.invert(img)
    #semillas del watershed + inhomogeneidad fuente de luz
    # tomar mediana de todas las im[agenes]--> iluminacion del microscopio
    #background posta
    #normalizo por la mediana - iluminacion de background
    #corregir por iluminacion
